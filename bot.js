...
app.get("/", (request, response) => {
  console.log(Date.now() + "Astrea Bot Altyapısı");//dokunmayın çalışmaz
  response.sendStatus(200);
});
app.listen(process.env.PORT);
setInterval(() => {
  http.get(`https://astreapremium.glitch.me/`);
}, 280000);
        ...
        if (reklam.some(word => msg.content.includes(word))) {//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn
          try {
            if (!msg.member.hasPermission("BAN_MEMBERS")) {//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn
                  msg.delete();
                    return msg.reply('<a:carpi:756903750551076964> Reklam yapmak yasak! **Mesajın silindi**.').then(msg => msg.delete(3000));
...
client.on("guildMemberAdd", async member => {
  ...
  client.channels
    .get(frenzykanal)
    .send(
      `Sunucumuza Yeni Biri Geldi Ve İsmi ${member}, Hoşgeldin Kanka  **${frenzysayı}** Kişiye Ulaşmak İçin  **${sonuç}** Kişi Kaldı.`
    );
});
      ...
      if (!role) {
        ...
        var embed = new Discord.RichEmbed()//ukqzn
          .setDescription(//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn
            `**Sunucuya Hoşgeldin Kankam** \`${member.user.tag}\` \`${role}\` **rolün verildi.**`//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn
          ...
          .setFooter(`Astrea Otorol Sistemi`);//ukqzn
...
.setTitle("SES KANALI OLUŞTURULDU")
				...
				.setFooter(`Astrea | MOD-LOG Sistemi Kanal ID: ${channel.id}`)
            ...
            if (!message.member.hasPermission("ADMINISTRATOR")) {
                ...
                if (uyarisayisi === null) {
                    let uyari = new Discord.RichEmbed()
                        ...
                        .setDescription(`<@${message.author.id}> <a:uyar:756616504744607845> Astrea Reklam Kick Sistemine yakalandın! Reklam yapmaya devam edersen kickleniceksin (1/3)`)
                        .setTimestamp()
                ...
                if (uyarisayisi === 1) {
                    let uyari = new Discord.RichEmbed()
                        .setColor("RANDOM")
                        .setFooter('Astrea | Reklam Kick Sistemi', client.user.avatarURL)
                        .setDescription(`<@${message.author.id}> <a:uyar:756616504744607845> <a:uyar:756616504744607845> Astrea Reklam Kick Sistemine yakalandın! Reklam yapmaya devam edersen kickleniceksin (2/3)`)
                        .setTimestamp()
                    message.channel.send(uyari)
                }
                if (uyarisayisi === 2) {
                    ...
                    let uyari = new Discord.RichEmbed()
                        .setColor("RANDOM")
                        .setFooter('Astrea | Reklam Kick Sistemi', client.user.avatarURL)
                        .setDescription(`<@${message.author.id}> <a:uyar:756616504744607845> 3 adet reklam uyarısı aldığı için kicklendi. Bir kez daha yaparsa banlanacak!`)
                        .setTimestamp()
                    message.channel.send(uyari)
                }
                if (uyarisayisi === 3) {
                    message.delete();
                    await kullanici.ban({
                        reason: `Astrea |  Reklam Ban Sistemi`,
                    })
                    db.delete(`reklamuyari_${message.author.id}`)
                    let uyari = new Discord.RichEmbed()
                        .setColor("RANDOM")
                        .setFooter('Astrea | Reklam Kick Sistemi', client.user.avatarURL)
                        .setDescription(`<@${message.author.id}> <a:uyar:756616504744607845> kick yedikten sonra tekrar devam ettiği için banlandı.`)
                        .setTimestamp()
                    message.channel.send(uyari)
                }
...
if(member.guild.id != "729335386656079882") return
  ...
  require("moment-duration-format");
    ...
    var kontrol;
if (kurulus < 1296000000) kontrol = ' <a:uyar:756616504744607845> Bu Hesap Güvenilir Değil!'
if (kurulus > 1296000000) kontrol = ' <a:uyar:756616504744607845> Bu Hesap Güvenilir!'
  moment.locale("tr");
...
client.on("messageDelete", async message => {
  ...
  const embed = new Discord.RichEmbed()
    ...
    .setDescription(
      `<@!${message.author.id}> <a:uyar:756616504744607845> adlı kullanıcı tarafından <#${message.channel.id}> kanalına gönderilen mesaj silindi!\n\nSilinen Mesaj: **${message.content}**`
    )
    .setFooter("Astrea | Log Sistemi");
  modlogkanal.sendEmbed(embed);
});
client.on("guildBanAdd", async message => {
  let modlogs = db.get(`tc-modlog_${message.guild.id}`);
  ...
  const embed = new Discord.RichEmbed()
    .setColor("PURPLE")
    .setDescription(
      `<a:uyar:756616504744607845> Üye Sunucudan Yasaklandı! \n<@!${message.user.id}>, ${message.user.tag}`
    )
    .setThumbnail(message.user.avatarURL)
    .setFooter("Astrea | Log Sistemi");
  modlogkanal.sendEmbed(embed);
...
client.on("channelCreate", async channel => {
  ...
  if (channel.type === "text") {
    let embed = new Discord.RichEmbed()
      .setColor("PURPLE")
      .setDescription(`${channel.name} adlı metin kanalı oluşturuldu.`)
      .setFooter(`Astrea | Log Sistemi Kanal ID: ${channel.id}`);
    modlogkanal.send({ embed });
  }
  if (channel.type === "voice") {
    let embed = new Discord.RichEmbed()
