...
exports.run = async (client, message, args) => {
  ...
  message.channel
    .send(`Fotoğraf işleniyor, lütfen bekleyin...`)
    .then(m => m.delete(1000));

  Jimp.read(
    "https://cdn.discordapp.com/attachments/617672562281021459/617793751527718923/adamol_icin.jpg",
    (err, image) => {
